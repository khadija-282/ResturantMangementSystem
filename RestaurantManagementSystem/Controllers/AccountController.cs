...
namespace RestaurantManagementSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    ul.LevelId = 0;
        //    ul.LevelName = "-- Select UserLevel --";
        //    UserLevels.Insert(0, ul);
        //    ViewBag.LevelId = UserLevels;// new SelectList(db.UserLevels, "LevelId", "LevelName");

        //    RegisterViewModel model = new RegisterViewModel();
        //    var roles = db.AspNetRoles.Where(a => a.LevelId == 1);
        //    model.UserRoles = roles.ToList();
        //    return View(model);
        //}
        public JsonResult GetRoles(int levelId)
        {
