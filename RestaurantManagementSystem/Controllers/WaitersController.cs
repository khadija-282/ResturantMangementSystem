...
namespace RestaurantManagementSystem.Controllers
{
    public class WaitersController : Controller
    {
        ...
        {
            return View(await db.Waiters.ToListAsync());
        }
        ...
        public async Task<ActionResult> Details(long? id)
        {
            ...
            Waiter waiter = await db.Waiters.FindAsync(id);
            if (waiter == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name")] Waiter waiter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name")] Waiter waiter)
        {
            if (ModelState.IsValid)
            {
